...
export const ImpactAccess: React.FC<ImpactAccessProps> = ({ selectOffboadingScope,onRemoveOptionChange,selectedOption,selectedOffBoardngImpactTools,setSelectedOffBoardingImpactTools }) => {
  return (
    <div>
      <div>
