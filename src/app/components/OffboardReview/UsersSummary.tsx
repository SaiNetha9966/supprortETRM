        ...
        <div className="flex items-center gap-8">
          {status === 'offboarded' ? (
            <div className="bg-[#ffebed] border border-[#f1b5b7] rounded-full px-2.5 h-6 flex items-center">
              <span className="font-normal text-[13px] text-[#bf494e] leading-none">User will be offboarded</span>
            </div>
          ) : (
          ...
          <div className="w-6 h-6 relative shrink-0">
            <div className="absolute" style={{ aspectRatio: '12.00000286102295/7.409999847412109', bottom: '29.17%', left: '50%', top: '33.33%', transform: 'translateX(-50%)' }}>
              <svg className="absolute block inset-0" fill="none" preserveAspectRatio="none" viewBox="0 0 14 9">
