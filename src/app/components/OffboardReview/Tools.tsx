        ...
        <div className="flex flex-col gap-5">
          {
            selectOffboadingScope === "project" && (
             <h2 className="font-bold text-[19px] text-[#4a4a4a]">Tools Impacted (All tools will be offboarder)</h2>

            )
          }
                    {
            selectOffboadingScope === "tools" && (
             <h2 className="font-bold text-[19px] text-[#4a4a4a]">Tools Impacted (Selected tools only)</h2>
