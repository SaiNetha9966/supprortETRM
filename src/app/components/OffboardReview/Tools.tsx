...
function ToolItem({ name, platform }: ToolItemProps) {
  return (
    <div className="flex flex-col gap-2">
      ...
      <div className="bg-[#e0eaff] border border-[#9bb5fd] rounded-full px-2.5 h-6 flex items-center w-fit">
    ...
    <section className="bg-white rounded-lg p-6">
      <div className="flex flex-col gap-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <ToolItem name="Teams Site" platform="AP Platform" />
          <ToolItem name="Tool Builder" platform="AP Platform" />
          <ToolItem name="Company Health Check" platform="AP Platform" />
        </div>
      </div>
    </section>
  );
