                    ...
                    >
                      {allChecked && (
                        <svg width="10" height="8" viewBox="0 0 10 8" fill="none">
                          <path d="M1 4L3.5 6.5L9 1" stroke="#878787" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                        </svg>
                      )}
                    </div>
                ...
                <tr key={tool.id} className="bg-white border-b border-[#e7e7e7]">
                  ...
                  <td className="px-2.5 py-4">
                    <div className="relative w-60">
                      <select className="bg-white border border-[#ccc] rounded px-2 py-1.5 w-full font-['Roboto',sans-serif] font-normal text-[14px] leading-[19px] text-[#28292c] appearance-none cursor-pointer">
                     ...
                     <td className="px-2.5 py-4">
                    <div className="relative w-60">
                      <input className="bg-white border border-[#ccc] rounded px-2 py-1.5 w-full font-['Roboto',sans-serif] font-normal text-[14px] leading-[19px] text-[#28292c] appearance-none cursor-pointer" type="text"/>
