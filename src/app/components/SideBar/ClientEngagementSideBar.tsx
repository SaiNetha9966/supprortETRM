...
interface ClientEngagementSidebarProps {
  isOpen: boolean;
  onClose: () => void;
  currentStep: string;
...
export const ClientEngagementSidebar: React.FC<ClientEngagementSidebarProps> = ({
  isOpen,
  onClose,
  currentStep,
  existingProject,
  ...
  const menuItems: MenuItem[] = [
    {
      id: 'etfr-data-details',
      label: 'ETRF & Data Details',
      icon: currentStep === 'project-details' ? <ProjectSetupIcon active /> : <ProjectSetupIcon />,
