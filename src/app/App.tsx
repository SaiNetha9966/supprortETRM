...
import { ExistingProjectDetails } from './components/ExistingProjectDetails/ExistingProjectDetails';
import { ActionButtons } from './components/ActionButtons/ActionButtons';
import ToolConfiguration from './components/ToolConfiguration/ToolConfiguration';
import ExistingToolConfiguration from './components/ToolConfiguration/ExistingToolConfiguration';
...
export default function App() {
  ...
  const handleContinue = async() => {
    if (currentStep === 'project-details' && existingProject === 'yes' && !existingProjectDetailsFormData?.selectedProjectKey) {
      return;
    }
    switch (currentStep) {
      ...
      case 'tool-configuration':
        ...
        if (existingProject === 'yes') {
          setPageTittle('Update Existing Project');
  ...
  useEffect(() => {
    async function loadData() {
      try {
        const result = await fetchNonClientNewProject();
        setData(result);
          ...
          <div className={styles.contentWrapper}>
            ...
            {currentStep === 'newclient-intro' && (
              <div className={styles.centerWrapper}>
                <NonClientProjectForm onContinue={handleNonClientContinue} />
              </div>
            )}
